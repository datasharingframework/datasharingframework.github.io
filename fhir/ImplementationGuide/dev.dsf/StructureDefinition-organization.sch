...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization">
      <sch:assert test="count(f:extension[@url = 'http://dsf.dev/fhir/StructureDefinition/extension-certificate-thumbprint|2.0.0']) &gt;= 1">extension with URL = 'http://dsf.dev/fhir/StructureDefinition/extension-certificate-thumbprint|2.0.0': minimum cardinality of 'extension' is 1</sch:assert>
