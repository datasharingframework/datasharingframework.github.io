...
2. **Verify organizational membership**  
...
To enforce **Role-based permissions**, so what actions an organization is allowed to perform in a given use case, please read the [ActivityDefinition page](./activitydefinition.html).
