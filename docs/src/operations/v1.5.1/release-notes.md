...
- To Update an existing 1.x installation, please see the [1.x -> 1.5.1 Upgrade Guide](/operations/v1.5.1/upgrade-from-1.html).
- For a fresh deployment, follow the [installation instructions](/operations/v1.5.1/install.html).
