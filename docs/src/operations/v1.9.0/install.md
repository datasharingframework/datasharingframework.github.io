...
1. Download and Extract Config Files  
    ...
    ```
    cd /opt
    wget https://dsf.dev/download/dsf_fhir_1_9_0.tar.gz
    sudo tar --same-owner -zxvf dsf_fhir_1_9_0.tar.gz
    ```
...
1. Download and Extract Config Files  
    ...
    ```
    cd /opt
    wget https://dsf.dev/download/dsf_bpe_1_9_0.tar.gz
    sudo tar --same-owner -zxvf dsf_bpe_1_9_0.tar.gz
    ```
