...
A number of additional `DEV_DSF_SERVER_AUTH_OIDC ...` configuration parameters are specified on the DSF FHIR server [configuration parameter page](configuration).
