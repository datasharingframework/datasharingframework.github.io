...
- To Update an existing 1.x installation, please see the [1.x -> 1.7.0 Upgrade Guide](/operations/v1.7.0/upgrade-from-1.html). **Note:** Upgrading to 1.7.0 requires additional work beyond updating the version number.
- For a fresh deployment, follow the [installation instructions](/operations/v1.7.0/install.html).
