...
1. Download and Extract Config Files  
    ...
    ```
    cd /opt
    wget https://dsf.dev/download/dsf_fhir_2_1_0.tar.gz
    sudo tar --same-owner -zxvf dsf_fhir_2_1_0.tar.gz
    ```
...
1. Download and Extract Config Files  
    ...
    ```
    cd /opt
    wget https://dsf.dev/download/dsf_bpe_2_1_0.tar.gz
    sudo tar --same-owner -zxvf dsf_bpe_2_1_0.tar.gz
    ```
