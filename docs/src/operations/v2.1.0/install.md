...
1. Download and Extract Config Files  
    ...
    ```
    cd /opt
    wget https://dsf.dev/download/dsf_fhir_{{release.tagUnderscored}}.tar.gz
    sudo tar --same-owner -zxvf dsf_fhir_{{release.tagUnderscored}}.tar.gz
    ```
...
1. Download and Extract Config Files  
    ...
    ```
    cd /opt
    wget https://dsf.dev/download/dsf_bpe_{{release.tagUnderscored}}.tar.gz
    sudo tar --same-owner -zxvf dsf_bpe_{{release.tagUnderscored}}.tar.gz
    ```
