# ProcessAuthorizationParentOrganizationRole - Data Sharing Framework (DSF) Implementation Guide v2.0.0
...
* Use this Extension: [ProcessAuthorizationLocalParentOrganizationRole](StructureDefinition-coding-process-authorization-local-parent-organization-role.md) and [ProcessAuthorizationRemoteParentOrganizationRole](StructureDefinition-coding-process-authorization-remote-parent-organization-role.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/dev.dsf|current/StructureDefinition/extension-process-authorization-parent-organization-role)
...
Other representations of profile: [CSV](StructureDefinition-extension-process-authorization-parent-organization-role.csv), [Excel](StructureDefinition-extension-process-authorization-parent-organization-role.xlsx), [Schematron](StructureDefinition-extension-process-authorization-parent-organization-role.sch) 
...
```json
{
  ...
  "id" : "extension-process-authorization-parent-organization-role",
  "meta" : {
    "profile" : [
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://dsf.dev/fhir/StructureDefinition/extension-process-authorization-parent-organization-role"
      },
      {
