...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">              - HISTORY</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The list of user roles above contains a single rule-entry <code v-pre>example_read_only_role</code>, matching the user via a client certificate SHA-512 thumprint and assigning three DSF roles. Any string can be used as the name for the rule-enty.</p>
<div class="hint-container tip">
<p class="hint-container-title">Certificate Thumbprints</p>
<p>SHA-512 certificate thumbprints in HEX form <code v-pre>[a-f0-9]{128}</code> can be calculated using:</p>
<div class="language-sh line-numbers-mode" data-highlighter="shiki" data-ext="sh" data-title="sh" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">certtool</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> --fingerprint</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> --hash=sha512</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> --infile=certificate.pem</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></div>
<p>Multiple user roles can be specified and all matching roles will be applied to an authenticated users. Use an empty string <code v-pre>&quot;&quot;</code> or a single block scalar <code v-pre>|</code> character as the value for the configuration parameter <a href="configuration#dev-dsf-fhir-server-roleconfig">DEV_DSF_FHIR_SERVER_ROLECONFIG</a> if no roles should be configured.</p>
<h2 id="matching-users" tabindex="-1"><a class="header-anchor" href="#matching-users"><span>Matching Users</span></a></h2>
<p>To apply roles, users can be matched via the <code v-pre>thumbprint</code>, <code v-pre>email</code>, <code v-pre>token-role</code> or <code v-pre>token-group</code> properties. A single value or a list of values can be specified.</p>
<h4 id="thumbprint" tabindex="-1"><a class="header-anchor" href="#thumbprint"><span>thumbprint</span></a></h4>
<p>The property <code v-pre>thumbprint</code> can used to specify one or multiple SHA-512 certificate thumbprints. Roles from this rule are applied to the authenticating user if the certificate matches one of the specified thumbprints.</p>
<h4 id="email" tabindex="-1"><a class="header-anchor" href="#email"><span>email</span></a></h4>
<p>Using the property <code v-pre>email</code> users can be matched against e-mail addresses specified in X.509 client certificates and in OpenID Connect access tokens. Values will be matched against e-mail addresses specified in the subject DN (via PKCS#9 extension 1.2.840.113549.1.9.1) and RFC-822 Name entries of the Subject Alternative Name field. If the user authenticates via OpenID Connect, the <code v-pre>email</code> <a href="https://openid.net/specs/openid-connect-core-1_0.html#StandardClaims" target="_blank" rel="noopener noreferrer">claim</a> from the access token will be matched against the property values.</p>
<h4 id="token-role-and-token-group" tabindex="-1"><a class="header-anchor" href="#token-role-and-token-group"><span>token-role and token-group</span></a></h4>
<p>With the properties <code v-pre>token-role</code> and <code v-pre>token-group</code> role and group names can be specified to match against role and group claims within OAuth 2.0 access tokens.</p>
<h2 id="dsf-and-practitioner-roles" tabindex="-1"><a class="header-anchor" href="#dsf-and-practitioner-roles"><span>DSF and Practitioner Roles</span></a></h2>
<p>Two types of roles can be applied to matched users.</p>
<h4 id="dsf-role" tabindex="-1"><a class="header-anchor" href="#dsf-role"><span>dsf-role</span></a></h4>
<p>DSF roles specified via the <code v-pre>dsf-role</code> property define general access to the REST API and user interface. Allowed values are:</p>
<p><code v-pre>CREATE</code>, <code v-pre>READ</code>, <code v-pre>UPDATE</code>, <code v-pre>DELETE</code>, <code v-pre>SEARCH</code>, <code v-pre>HISTORY</code>, <code v-pre>PERMANENT_DELETE</code> and <code v-pre>WEBSOCKET</code>.</p>
<h4 id="practitioner-role" tabindex="-1"><a class="header-anchor" href="#practitioner-role"><span>practitioner-role</span></a></h4>
<p>In order to allow users to start processes, the property <code v-pre>practitioner-role</code> can be used to assign codes from FHIR <a href="http://hl7.org/fhir/R4/codesystem.html" target="_blank" rel="noopener noreferrer">CodeSystem</a> resources. Codes are specified in the form <code v-pre>system-url|code</code>.<br>
If the uses has a code specified here that match with a <code v-pre>requester</code> extension within the process plugin's <a href="http://hl7.org/fhir/R4/activitydefinition.html" target="_blank" rel="noopener noreferrer">ActivityDefinition</a> resource, the user can start the process if he also has the <code v-pre>dsf-role</code> <code v-pre>CREATE</code>.</p>
<p>Process plugins can defined and use there own code-systems. However, the DSF specifies a standard set of practitioner roles within the CodeSystem <code v-pre>http://dsf.dev/fhir/CodeSystem/practitioner-role</code>:</p>
<p><code v-pre>UAC_USER</code>, <code v-pre>COS_USER</code>, <code v-pre>CRR_USER</code>, <code v-pre>DIC_USER</code>, <code v-pre>DMS_USER</code>, <code v-pre>DTS_USER</code>, <code v-pre>HRP_USER</code>, <code v-pre>TTP_USER</code>, <code v-pre>AMS_USER</code> and <code v-pre>DSF_ADMIN</code>.</p>
<h2 id="examples" tabindex="-1"><a class="header-anchor" href="#examples"><span>Examples</span></a></h2>
<p>The first example defines a group of DSF administrators. Two client certificates match against this role:</p>
<div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" data-title="yaml" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">      DEV_DSF_FHIR_SERVER_ROLECONFIG</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">: </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">|</span></span>
...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">              - http://dsf.dev/fhir/CodeSystem/practitioner-role|DSF_ADMIN</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The second example defines a group of DSF administrators by specifying an <code v-pre>admin</code> role that gets matched against OAuth 2.0 access tokens:</p>
<div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" data-title="yaml" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">      DEV_DSF_FHIR_SERVER_ROLECONFIG</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">: </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">|</span></span>
