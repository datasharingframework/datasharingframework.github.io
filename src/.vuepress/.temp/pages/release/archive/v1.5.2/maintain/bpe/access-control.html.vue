...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">              - ADMIN</span></span></code></pre>
...
<p>Multiple user roles can be specified and all matching roles will be applied to an authenticated users. Use an empty string <code v-pre>&quot;&quot;</code> or a single block scalar <code v-pre>|</code> character as the value for the configuration parameter <a href="configuration#dev-dsf-bpe-server-roleconfig">DEV_DSF_BPE_SERVER_ROLECONFIG</a> if no roles should be configured.</p>
...
<p>DSF roles specified via the <code v-pre>dsf-role</code> property define general access to the user interface. Allowed values are:</p>
<p><code v-pre>ADMIN</code>.</p>
<h4 id="practitioner-role" tabindex="-1"><a class="header-anchor" href="#practitioner-role"><span>practitioner-role</span></a></h4>
<p>The BPE server currently does not support any practionier-roles.</p>
...
<div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" data-title="yaml" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">      DEV_DSF_BPE_SERVER_ROLECONFIG</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">: </span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">|</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">        - email-admins:</span></span>
