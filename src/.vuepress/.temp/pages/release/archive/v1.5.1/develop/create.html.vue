<template><div><p>Visit the <RouteLink to="/release/archive/for-you/">how the DSF can help you</RouteLink> page to get started.</p>
<div class="hint-container tip">
<p class="hint-container-title">Work in progress</p>
<p>We are currently in the process of updating the written documentation on how to create a DSF process plugin. In the meantime we recommend to study the oldstable version of the <RouteLink to="/oldstable/tutorial/">process plugin tutorial</RouteLink>. Additionally, we recommend to take a look at the upgraded DSF processes here:</p>
<ul>
