<template><div><h3 id="dev-dsf-server-api-host" tabindex="-1"><a class="header-anchor" href="#dev-dsf-server-api-host"><span>DEV_DSF_SERVER_API_HOST</span></a></h3>
<ul>
...
<li><strong>Required:</strong> Yes</li>
<li><strong>Description:</strong> Address of the database used for the DSF BPE server</li>
...
<li><strong>Required:</strong> Yes</li>
<li><strong>Description:</strong> Password to access the database from the DSF BPE server for camunda processes</li>
...
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Username to access the database from the DSF BPE server for camunda processes</li>
...
<li><strong>Required:</strong> Yes</li>
<li><strong>Description:</strong> Password to access the database from the DSF BPE server</li>
...
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Username to access the database from the DSF BPE server</li>
<li><strong>Default:</strong> <code v-pre>bpe_server_user</code></li>
</ul>
<h3 id="dev-dsf-bpe-debug-log-message-currentuser" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-debug-log-message-currentuser"><span>DEV_DSF_BPE_DEBUG_LOG_MESSAGE_CURRENTUSER</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.debug.log.message.currentUser</li>
<li><strong>Required:</strong> No</li>
...
<h3 id="dev-dsf-bpe-debug-log-message-dbstatement" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-debug-log-message-dbstatement"><span>DEV_DSF_BPE_DEBUG_LOG_MESSAGE_DBSTATEMENT</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.debug.log.message.dbStatement</li>
<li><strong>Required:</strong> No</li>
...
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> To enable logging of bpmn variables for every bpmn activity start or end, when logging of these events is enabled, set to <code v-pre>true</code>.</li>
...
<h3 id="dev-dsf-bpe-debug-log-message-variableslocal" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-debug-log-message-variableslocal"><span>DEV_DSF_BPE_DEBUG_LOG_MESSAGE_VARIABLESLOCAL</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.debug.log.message.variablesLocal</li>
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> To enable logging of local bpmn variables for every bpmn activity start or end, when logging of these events is enabled, set to <code v-pre>true</code>.</li>
<li><strong>Recommendation:</strong> This debug function should only be activated during process plugin development. WARNNING: Confidential information may be leaked via the debug log!</li>
<li><strong>Default:</strong> <code v-pre>false</code></li>
</ul>
<h3 id="dev-dsf-bpe-debug-log-message-webservicerequest" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-debug-log-message-webservicerequest"><span>DEV_DSF_BPE_DEBUG_LOG_MESSAGE_WEBSERVICEREQUEST</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.debug.log.message.webserviceRequest</li>
<li><strong>Required:</strong> No</li>
...
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Timeout in milliseconds until a connection is established with the local DSF FHIR server</li>
...
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Timeout in milliseconds until reading a resource from the local DSF FHIR server is aborted</li>
<li><strong>Recommendation:</strong> Change default value only if timeout exceptions occur</li>
...
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Timeout in milliseconds until a connection is established with a remote DSF FHIR server</li>
<li><strong>Recommendation:</strong> Change default value only if timeout exceptions occur</li>
<li><strong>Default:</strong> <code v-pre>5000</code></li>
</ul>
...
<li><strong>Required:</strong> Yes</li>
<li><strong>Description:</strong> Base address of the local DSF FHIR server to read/store fhir resources</li>
...
<h3 id="dev-dsf-bpe-process-engine-corepoolsize" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-process-engine-corepoolsize"><span>DEV_DSF_BPE_PROCESS_ENGINE_COREPOOLSIZE</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.process.engine.corePoolSize</li>
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Process engine job executor core pool size</li>
<li><strong>Default:</strong> <code v-pre>4</code></li>
</ul>
<h3 id="dev-dsf-bpe-process-engine-maxpoolsize" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-process-engine-maxpoolsize"><span>DEV_DSF_BPE_PROCESS_ENGINE_MAXPOOLSIZE</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.process.engine.maxPoolSize</li>
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Process engine job executor max pool size, additional threads until max pool size are created if the queue is full</li>
<li><strong>Default:</strong> <code v-pre>10</code></li>
</ul>
<h3 id="dev-dsf-bpe-process-engine-queuesize" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-process-engine-queuesize"><span>DEV_DSF_BPE_PROCESS_ENGINE_QUEUESIZE</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.process.engine.queueSize</li>
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Process engine job executor queue size, jobs are added to the queue if all core pool threads are busy</li>
<li><strong>Default:</strong> <code v-pre>40</code></li>
</ul>
...
<li><strong>Example:</strong> <code v-pre>dsfdev_updateAllowList|1.0, another_process|x.y</code></li>
</ul>
...
<li><strong>Example:</strong> <code v-pre>old_process|x.y</code></li>
</ul>
<h3 id="dev-dsf-bpe-process-threads" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-process-threads"><span>DEV_DSF_BPE_PROCESS_THREADS</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.process.threads</li>
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Number of parallel Task / QuestionnaireResponse threads to start new or continue existing processes, a value <code v-pre>&lt;= 0</code> means number of cpu cores</li>
<li><strong>Default:</strong> <code v-pre>-1</code></li>
</ul>
<h3 id="dev-dsf-bpe-server-base-url" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-server-base-url"><span>DEV_DSF_BPE_SERVER_BASE_URL</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.server.base.url</li>
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Base address of the BPE server, configure when exposing the web-ui</li>
<li><strong>Example:</strong> <code v-pre>https://foo.bar/bpe</code></li>
<li><strong>Default:</strong> <code v-pre>https</code></li>
</ul>
<h3 id="dev-dsf-bpe-server-roleconfig" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-server-roleconfig"><span>DEV_DSF_BPE_SERVER_ROLECONFIG</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.server.roleConfig</li>
<li><strong>Required:</strong> No</li>
<li><strong>Description:</strong> Role config YAML as defined in <a href="access-control">FHIR Server: Access Control</a>.</li>
</ul>
<h3 id="dev-dsf-bpe-server-static-resource-cache" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-server-static-resource-cache"><span>DEV_DSF_BPE_SERVER_STATIC_RESOURCE_CACHE</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.server.static.resource.cache</li>
<li><strong>Required:</strong> No</li>
...
<h3 id="dev-dsf-bpe-server-ui-theme" tabindex="-1"><a class="header-anchor" href="#dev-dsf-bpe-server-ui-theme"><span>DEV_DSF_BPE_SERVER_UI_THEME</span></a></h3>
<ul>
<li><strong>Property:</strong> dev.dsf.bpe.server.ui.theme</li>
<li><strong>Required:</strong> No</li>
